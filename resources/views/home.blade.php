                    ...
                    <div class="col-md-4 col-lg-3 mb-4">
                        <div class="card border-0 shadow-lg">
                            <a href="{{ route('book.detail', $book->id) }}">
                                ...
                                @else
                                    <img src="{{ asset('https://placehold.co/990x1400?text=No image') }}" alt="" class="card-img-top">
                                @endif
                            </a>
                            <div class="card-body">
                                ...
                                @php
                                    if($book->reviews_count > 0) {
                                        $avgRating = $book->reviews_sum_rating / $book->reviews_count; // შესწორებულია countl → count
                                    } else {
                                        $avgRating = 0;
                                    }
                ...
                @else
                    <div class="col-md-12 mt-4">
                        <div class="alert alert-info text-center">
                            <h4 class="my-2"><i class="fa fa-exclamation-circle me-2"></i> წიგნი არ მოიძებნა</h4>
                            <p class="mb-0">გთხოვთ შეცვალოთ საძიებო სიტყვა და სცადოთ თავიდან.</p>
                        </div>
                    </div>
                @endif
